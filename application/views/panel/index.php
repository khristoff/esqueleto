				...
				<div class="row same-height-cards">
					<div class="col-md-4">
						<div class="card no-border bg-dark text-white">
							<div class="card-img-overlay p-a-0" style="background: url(/assets/images/unsplash/img3.jpeg) no-repeat; background-size: cover;"></div>
							<div class="card-block">
								<div class="">
						...
						<div class="card text-white no-border relative" style="min-height:250px">
							<div class="slide absolute tp lt rt bt" data-ride="carousel" data-interval="3000">
								<div class="carousel-inner" role="listbox">
									<div class="item active" style="background-image:url(http://lorempixel.com/400/400);background-size:cover;background-repeat: no-repeat;background-position: 50% 50%;width:100%;height:100%;"></div>
									<div class="item" style="background-image:url(http://lorempixel.com/400/400?2);background-size:cover;background-repeat: no-repeat;background-position: 50% 50%;width:100%;height:100%;"></div>
									<div class="item" style="background-image:url(http://lorempixel.com/400/400?3);background-size:cover;background-repeat: no-repeat;background-position: 50% 50%;width:100%;height:100%;"></div>
								</div>
							</div>
				...
				<div class="row same-height-cards">
					...
					<div class="col-md-4">
						<div class="card row-equal align-middle bg-white no-border">
							...
							<div class="column" style="background: url(/assets/images/unsplash/img2.jpeg) no-repeat; background-size: cover;background-position: center center;">
								&nbsp;
							</div>
						</div>
					</div>
					...
					<div class="col-md-4">
						<div class="card no-border">
							<div class="card-block">
								...
								<div class="text-center">
									<img src="/assets/images/cactus.png" class="img-responsive center-block relative" alt="" style="max-width: 230px;left: 1rem;">
								</div>
								<div class="text-center">
