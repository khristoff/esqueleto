						...
						<div class="display-columns">
							<div class="column contacts-sidebar hidden-xs bg-white b-r">
								<div class="scroll">
									<div class="p-a">
										<nav role="navigation">
											<a href="javascript:;" class="btn btn-default btn-block m-b">You have a total of 50 contacts</a>
											<ul class="nav nav-stacked nav-pills">
												...
												<li>
													<a href="javascript:;">
														<i class="icon-tag text-default"></i>
														<span>Archives</span>
													</a>
												</li>
											</ul>
							...
							<div class="column contacts-list bg-white b-r">
								<div class="ioslist">
									...
									<div class="ioslist-group-container">
										...
										<ul>
											<li>Bertha Martínez</li>
											<li>Bodrogi Szandra</li>
											<li>Barbara Palmer</li>
										</ul>
									</div>
									<div class="ioslist-group-container">
										<div class="ioslist-group-header">c</div>
										<ul>
											<li>Codruț Posteucă</li>
											<li>Cristina Carrillo</li>
											<li>César Arroyave</li>
											<li>Crenguța Cadanțu</li>
											<li>Carmen Viles</li>
											<li>Carmen Ungur</li>
										</ul>
									</div>
									<div class="ioslist-group-container">
										...
										<ul>
											<li>David chiopu</li>
											<li>Danielle Hoffman</li>
											<li>Dávid Ildikó</li>
											<li>Douglas Curtis</li>
										</ul>
									</div>
									<div class="ioslist-group-container">
										...
										<ul>
											<li>Eric Owens</li>
											<li>Eugenia elmaru</li>
										</ul>
									</div>
									<div class="ioslist-group-container">
										<div class="ioslist-group-header">f</div>
										<ul>
											<li>Francesca Cuza</li>
											<li>Franc Kralj</li>
										</ul>
									</div>
									<div class="ioslist-group-container ioslist-animated">
									...
									<div class="ioslist-group-container">
										...
										<ul>
											<li>Luca Saunderson</li>
										</ul>
									</div>
									<div class="ioslist-group-container">
										<div class="ioslist-group-header">m</div>
										<ul>
											<li>Manuela Aigner</li>
											<li>Mikayla Vosper</li>
											<li>Mary Morales</li>
											<li>Marco Conte</li>
											<li>Marc Wagner</li>
										</ul>
									...
									<div class="ioslist-group-container">
										...
										<ul>
											<li>Tudora Barbu</li>
											<li>Tudosia Bănică</li>
											<li>Titus Dolgan</li>
											<li>Teodora Coșbuc</li>
										</ul>
									</div>
									<div class="ioslist-group-container">
										...
										<div class="contact-header m-b">
											...
											<div class="p-a">
												<div class="pull-left p-r">
													<img src="/assets/images/face4.jpg" class="avatar avatar-lg img-circle" alt="">
												</div>
