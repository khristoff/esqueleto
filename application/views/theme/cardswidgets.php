...
?>
				<div class="page-title">
					...
					<div class="sub-title">Reusable UI Components</div>
				</div>
				<div class="row">
					<div class="col-lg-4">
						<div class="card bg-brown text-white">
							<div class="card-block">
								...
								<div class="">
									...
									<a href="#" class="card-link m-l-0"><i class="icon-link"></i>&nbsp;website.com</a>
								</div>
							</div>
						</div>
						<div class="row">
								...
								<ul class="list-unstyled">
									<li class="m-b">
										<div class="cs-checkbox">
											...
											<label for="1">Learn AngularJS</label>
										</div>
									</li>
									<li class="m-b">
										<div class="cs-checkbox">
											<input type="checkbox" id="2" value="">
											<label for="2">Buy groceries</label>
										</div>
									</li>
									<li class="m-b">
										<div class="cs-checkbox">
											<input type="checkbox" id="3" value="">
											<label for="3">Update server files</label>
										</div>
									</li>
								</ul>
							</div>
					...
					<div class="col-lg-4">
						<div class="card bg-white b-a-0">
							<img class="card-img-top img-responsive" src="http://lorempixel.com/400/150" alt="Card image cap">
							<div class="row text-center">
								<div class="col-sm-4 col-xs-12 p-t p-b">
									<h4 class="m-t-0 m-b-0">56</h4>
									<small class="text-muted bold">Comments</small>
								</div>
								<div class="col-sm-4 col-xs-12 p-t p-b">
									<h4 class="m-t-0 m-b-0">89</h4>
									<small class="text-muted bold">Likes</small>
								</div>
								<div class="col-sm-4 col-xs-12 p-t p-b">
									<h4 class="m-t-0 m-b-0">6,465</h4>
									<small class="text-muted bold">Shares</small>
								</div>
							</div>
						</div>
						<div class="card no-border">
							<div class="row-equal align-middle">
								<div class="col-xs-8 column p-l-0 p-r-0">
									<img class="img-responsive" src="/assets/images/unsplash/img3.jpeg" alt="">
								</div>
								<div class="col-xs-4 column bg-blue text-white p-l-0 p-r-0 text-center">
									<div class="h4 m-t-0">09&deg;</div>
									<p>Thunderstorms</p>
									<div class="climacon lightning sun fa-3x"></div>
								</div>
							</div>
						</div>
					...
					<div class="col-lg-4">
						...
						<div class="card card-inverse bg-bluegrey text-white text-center">
							<div class="card-block">
								<div class="clearfix">
									<div class="pull-right">90 Followers</div>
									<div class="pull-left">128 Following</div>
								</div>
								<img src="/assets/images/face1.jpg" alt="" class="img-thumbnail img-circle">
								<h5>Sean Carpenter</h5>
								<p><i class="icon-pointer"></i> San Francisco, CA</p>
								<div class="clearfix">
									<div class="pull-right">982 Likes</div>
									<div class="pull-left">921 Requests</div>
								</div>
							</div>
						</div>
					</div>
